...
import { clearAllProjectErrors, getAllProjects, updateProject, resetProjectSlice } from '../store/slices/projectSlice'
...
const UpdateProject = () => {
  ...
  useEffect(() => {
    const getProject = async () => {
      await axios.get(`${backendUrl}/api/v1/project/getsingle/${id}`, {
