...
export const getAllSkill = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get(`${backendUrl}/api/v1/skill/getAll`, { withCredentials: true })
        dispatch(skillSlice.actions.getAllSkillsSuccess(response.data.getAll))
...
export const deleteSkill = (id) => async (dispatch) => {
    ...
    try {
        const response = await axios.delete(`${backendUrl}/api/v1/skill/delete/${id}`, {
            withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
    ...
    try {
        const response = await axios.put(`${backendUrl}/api/v1/skill/update/${id}`, { proficiency }, {
            withCredentials: true,
            headers: {
